...
# ignore these files while searching through directories
...
def process_url( url ):
    ...
    print( "....fetch text of page at {}".format(url) )
...
def process_sourcedir( source_dir ):
    ...
    print( "Process source folder: {}".format(source_dir) )
    ...
    with open( sources_file ) as fp:
        ...
        print( "...reading URLs from {}".format(sources_file) )
        ...
        for url in urls:
            ...
            ## construct the filename we'll be writing to...s
            ...
            print( ".....write page text to {}".format(fn_out) )
